...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        pdf_dir   = os.path.join(settings.MEDIA_ROOT, "forecast", "general", "doc")
        ...
        try:
            ...
            head_request = urllib.request.Request(pdf_url, method="HEAD", headers={"User-Agent": "WIMP3 General Forecast PDF Sync"})
