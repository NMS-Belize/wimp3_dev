...
API_URL = "https://wimp.nms.gov.bz/api/forecast_daily/read_pdf.php"
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        pdf_dir   = os.path.join(settings.MEDIA_ROOT, "forecast", "daily", "doc")
        ...
        try:
            ...
            head_request = urllib.request.Request(pdf_url, method="HEAD", headers={"User-Agent": "WIMP3 Daily Forecast PDF Sync"})
