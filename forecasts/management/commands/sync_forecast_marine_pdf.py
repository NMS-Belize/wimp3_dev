...
API_URL = "https://wimp.nms.gov.bz/api/forecast_marine/read.php"
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        pdf_dir   = os.path.join(settings.MEDIA_ROOT, "forecast", "marine", "doc")
        ...
        try:
            ...
            head_request = urllib.request.Request(pdf_url, method="HEAD", headers={"User-Agent": "WIMP3 Marine Forecast PDF Sync"})
