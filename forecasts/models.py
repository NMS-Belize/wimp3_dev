...
class DistrictForecastDetails(models.Model):
    ...
    winds_min       = models.DecimalField(default=0.00,max_digits=5,decimal_places=2)
    winds_max       = models.DecimalField(default=0.00,max_digits=5,decimal_places=2)
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["forecast", "district"],name="unique_district_per_forecast"
            )
        ]
