...
class DistrictForecastDetails(models.Model):
    ...
    temp_min        = models.DecimalField(default=0.0,max_digits=4,decimal_places=1)
    ...
    temp_max        = models.DecimalField(default=0.0,max_digits=4,decimal_places=1)
    ...
    winds_min       = models.DecimalField(default=0,max_digits=4,decimal_places=0)
    winds_max       = models.DecimalField(default=0,max_digits=4,decimal_places=0)
